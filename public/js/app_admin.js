...
/***/ "./resources/js/admin/apigeneralcategory.js":
/*!**************************************************!*\
  !*** ./resources/js/admin/apigeneralcategory.js ***!
  \**************************************************/
/*! no static exports found */
...
var apigeneralcategory = new Vue({
  el: '#apigeneralcategory',
  data: {
    nombre: '',
    slug: '',
    div_mensajeslug: 'Slug Existe',
  ...
  methods: {
    getCategory: function getCategory() {
      ...
      if (this.slug) {
        var url = '/api/general_category/' + this.slug;
        axios.get(url).then(function (response) {
          _this.div_mensajeslug = response.data;
...
if (document.getElementById('apigeneralcategory')) {
  __webpack_require__(/*! ./admin/apigeneralcategory */ "./resources/js/admin/apigeneralcategory.js");
}
...
var confirmareliminar = new Vue({
  ...
  methods: {
    ...
    deseas_eliminar2: function deseas_eliminar2(id) {
      //alert(id);
