  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="{{ route('admin')}}" class="brand-link">
        ...
        style="opacity: .8"> --}}
        <span class="brand-text font-weight-light" style="margin-right: 10px;margin-left: 10px;">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="https://docs.google.com/document/d/1KHeDQhVeay7bIsA3Y5Jms3Aj8C__uDDzRjadg_-iOPc/edit?usp=sharing"
                class="nav-link">
